...
export default function Layout() {
  ...
  return (
    <div className="container-fluid min-w-full flex min-h-screen bg-red-200">
      ...
      <div className="bg-red-400 w-full sm:w-1/4">
        {" "}
        {/** Left Column */}
        {/** TODO
      ...
      <div className="bg-red-700 w-3/4 lg:w-1/2 hidden sm:flex justify-center">
        {/** Middle / Main */}

        {rend()}
      </div>
      <div className="bg-grey-400 md:w-1/4 hidden lg:block">
        {/** Right Column */}
        <h3>Right Column</h3>
      </div>
    </div>
